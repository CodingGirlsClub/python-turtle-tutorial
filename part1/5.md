...
- 下载并安装 [集成开发环境 Anaconda](https://www.anaconda.com/download/)，记得选择Python 3.6 Version
  ![](https://github.com/yangyangxcf/python-tutorial-turtle/blob/master/gitbook/image/anaconda-3.6.png)
...
2. 现在你的桌面上(或者是你想要放代码的文件夹中)会出现一个叫做`GirlsCodingDayPythonDemo`的文件夹。
   ...
   ![](https://github.com/yangyangxcf/python-turtle-tutorial/blob/master/image/Anaconda.png)
   ![](https://github.com/yangyangxcf/python-turtle-tutorial/blob/master/image/Spyder.png)
3. 提交commit到master分支，（注意changes）
   ![](https://github.com/yangyangxcf/python-turtle-tutorial/blob/master/image/GithubCommit.png)
4. 发布到Github
...
![](https://github.com/yangyangxcf/python-turtle-tutorial/blob/master/image/anaconda_module.png)
